...
<script>
  import FabricInput from '@/components/fabric/FabricInput'
  import FabricShiftInput from '@/components/fabric/FabricShiftInput'
  ...
  export default {
    ...
    methods: {
      add () {
        ...
        this.loader = true
        this.$store.dispatch('fabric/create', {
    ...
    watch: {
      attribute: {
        immediate: true,
        handler () {
          this.$store.dispatch('fabric/fetch', {attribute: this.attribute})
