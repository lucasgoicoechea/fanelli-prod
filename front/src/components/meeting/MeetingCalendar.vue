  ...
  <div class="meeting-calendar" >
    <navigation :title="title"></navigation>
     <div class="meeting-history-list-delivered container-fluid">
       ...
       Calendario con las reuniones frecuentes: DIARIAS, MENSUALES y PERIODICAS
       <div class="filters">
          <div class="filter">
            <div class="col-xs-2">
                <h3>Mes</h3>
    ...
    <div class="container" >
      ...
      <div class="spinner-container">
        <spinner class="spinner" :show="meeting.loading" loadingMessage="Cargando reuniones...">
        </spinner>
      </div>
       
      <div class="menu-item-container row " v-show="meeting.list.length>0" >
        <div v-for="(item, index) in meeting.list"   :key="index" >
              <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2 collaborator-profile" v-if="item!=null" >
                  <header v-show="item">
                    <span>[DIA - {{ item.day }}]</span>
                  </header>
                  <div class="information" >
                  <div  v-for="(items, indexx) in item.meetings" :key="indexx" >
    ...
    methods: {
      ...
      successFetch (response) {
        if (response.meetings.length === 0) {
          ...
          this.meeting.list = response.meetings
        }
