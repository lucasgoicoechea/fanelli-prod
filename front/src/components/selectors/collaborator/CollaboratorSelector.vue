<template>
  <div class="collaborator-selector">
    <header v-if="reduced" class="reduced">
      <a @click="show">
        <span v-show="!hasSelected">Presione aquí para seleccionar colaborador</span>
    ...
    <div v-else-if="multipleSelection" class="multiple">
      <a @click="show" v-show="!disabled">
        <span v-show="!hasSelected">Presione aquí para seleccionar colaboradores</span>
        <span v-show="hasSelected">Presione aquí para cambiar colaboradores</span>
        <div class="actions">
          <img :src="showIcon" alt="buscar">
          <img @click.stop="clear" v-show="hasSelected" src="/static/img/checklists/cross.svg" alt="limpiar">
        </div>
    ...
    <div v-else class="full">
      ...
      <div class="information">
        <a @click="show">
          <span v-show="!hasSelected">Presione aquí para seleccionar colaborador</span>
          <span v-show="hasSelected">Presione aquí para cambiar colaborador</span>
          <div class="actions">
            <img :src="showIcon" alt="buscar">
            <img @click.stop="clear" v-show="hasSelected" src="/static/img/checklists/cross.svg" alt="limpiar">
          </div>
    ...
    <collaborator-list
      ...
      :show="showList"
      :typeList="typeList"
      :preSelection="preSelection"></collaborator-list>
  </div>
</template>
