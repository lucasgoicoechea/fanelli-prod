<template>
  <footer class="form-footer">
    <div class="action" @click="undo()">
      <img src="/static/img/checklists/undo.svg">
    </div>
    <div class="action true" @click="check(true)">
      <img src="/static/img/checklists/tick.svg">
    </div>
    <div class="action false" @click="check(false)">
      <img src="/static/img/checklists/cross.svg">
    </div>
    <div class="counter">
      ...
      endChecklist (datetime) {
        if ((datetime.getHours() === this.currentSchedule.ends) && !(this.reset)) {
          ...
          this.$modal.show('dialog', {
            text: 'Terminó el turno del checklist actual',
            buttons: [
              {
                title: 'Aceptar',
                handler: () => {
