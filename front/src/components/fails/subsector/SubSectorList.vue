<template>
  <transition name="slide-fade">
    <div class="sub-sector-list" v-show="show" :style="pushed">
...
<script>
  ...
  import SubSectorListItem from '@/components/fails/subsector/SubSectorListItem.vue'
  import { mapGetters, mapState } from 'vuex'

  export default {
    name: 'SubSectorList',
    components: {SearchNavigation, SubSectorListItem},
    props: {
      show: {
        type: Boolean,
        default: false
