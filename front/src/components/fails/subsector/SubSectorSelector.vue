<template>
  <div class="sub-sector-selector">
    <header v-if="reduced" class="reduced">
      <a @click="show">
        <span v-show="!hasSelected">Presione aquí para seleccionar subsectores</span>
    ...
    <div v-else-if="multipleSelection" class="multiple">
      <a @click="show" v-show="!disabled">
        <span v-show="!hasSelected">Presione aquí para seleccionar sub-sectores</span>
        <span v-show="hasSelected">Presione aquí para cambiar sub-sectores</span>
        <div class="actions">
          <img :src="showIcon" alt="buscar">
          <img @click.stop="clear" v-show="hasSelected" src="/static/img/checklists/cross.svg" alt="limpiar">
        </div>
    ...
    <sub-sector-list
      ...
      :show="showList"
      :typeList="typeList"
      :preSelection="preSelection"></sub-sector-list>
  </div>
</template>

<script>
  import SubSectorList from './SubSectorList.vue'
  import { mapState, mapGetters } from 'vuex'

  export default {
    name: 'SubSectorSelector',
    components: {SubSectorList},
    props: {
      reduced: {
        type: Boolean,
        default: false
