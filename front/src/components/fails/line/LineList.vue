<template>
  <transition name="slide-fade">
    <div class="line-list" v-show="show" :style="pushed">
...
<script>
  ...
  import LineListItem from '@/components/fails/line/LineListItem.vue'
  import { mapGetters, mapState } from 'vuex'

  export default {
    name: 'LineList',
    components: {SearchNavigation, LineListItem},
    props: {
      show: {
        type: Boolean,
        default: false
