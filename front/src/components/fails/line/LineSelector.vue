<template>
  <div class="line-selector">
    <header v-if="reduced" class="reduced">
      <a @click="show">
        <span v-show="!hasSelected">Presione aquí para seleccionar lineas</span>
    ...
    <div v-else-if="multipleSelection" class="multiple">
      <a @click="show" v-show="!disabled">
        <span v-show="!hasSelected">Presione aquí para seleccionar lineas</span>
        <span v-show="hasSelected">Presione aquí para cambiar lineas</span>
        <div class="actions">
          <img :src="showIcon" alt="buscar">
          <img @click.stop="clear" v-show="hasSelected" src="/static/img/checklists/cross.svg" alt="limpiar">
        </div>
    ...
    <line-list
      ...
      :show="showList"
      :typeList="typeList"
      :preSelection="preSelection"></line-list>
  </div>
</template>
