<template>
  <transition name="slide-fade">
    <div class="equipo-list" v-show="show" :style="pushed">
...
<script>
  ...
  import EquipoListItem from '@/components/fails/equipo/EquipoListItem.vue'
  import { mapGetters, mapState } from 'vuex'

  export default {
    name: 'EquipoList',
    components: {SearchNavigation, EquipoListItem},
    props: {
      show: {
        type: Boolean,
        default: false
