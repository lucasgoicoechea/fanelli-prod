      ...
      <!-- <div class="container-fluid" style="background-color: #567BDC;">
       <div class="row negro"  >
        ...
        <div v-for="(total,index) in hour.totals" class="row"  :key="index" >
          ...
          <div class="col-xs-3 col-sm-4 col-md-5 col-lg-5" v-show="hour && hour.sector && hour.sector !== 'EXTRUSORA'" >{{total.count | decimalFormat}}</div>
          <div class="col-xs-3 col-sm-4 col-md-5 col-lg-5"  v-show="hour && hour.sector && hour.sector === 'EXTRUSORA'" >{{total.count}}</div>
...
<script>
  import SupervisionpartHour from '@/components/supervisionPartsL3/SupervisionpartHour.vue'
  import { mapState, mapGetters } from 'vuex'
  import Const from '@/const'

  export default {
    name: 'SupervisionpartItem',
    components: {SupervisionpartHour},
    props: {
      hour: {
        type: Object
      },
