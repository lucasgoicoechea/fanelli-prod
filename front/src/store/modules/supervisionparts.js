...
const actions = {
  fetch ({commit, dispatch}, {sector}) {
    ...
    commit('loading', true)
    Vue.http.get(`supervisionpart/current/${sector}`)
      .then(
        (res) => {
          if (res.body.success) {
  ...
  fetchAll ({commit}) {
    commit('loading', true)
    return Vue.http.get(`supervisionpart`)
      .then(
        (res) => {
          if (res.body.success) {
  ...
  fetchLast30days ({commit}) {
    commit('loading', true)
    return Vue.http.get(`supervisionpart/dates`)
      .then(
        (res) => {
          if (res.body.success) {
  ...
  updateSupervisionpart ({commit, dispatch}, payload) {
    ...
    Vue.http.post('supervisionpart/', {hour: payload.hour}, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
  ...
  updateTotals ({commit, dispatch}, payload) {
    ...
    // commit('loadingSupervisionpart', {sector: payload.sector, id: payload.hour.id, value: true})
    Vue.http.post('supervisionpart/totals', payload, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
  ...
  updateHour ({commit, dispatch}, payload) {
    ...
    // las  lineas siguientes son para ir check por check
    // commit('loadingSupervisionpart', {sector: payload.sector, id: payload.hour.id, value: true})
    Vue.http.post('supervisionpart/updateHour', payload, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
  ...
  createObservation ({commit, dispatch}, payload) {
    ...
    task.type = Constants.request_types.SUPERVISIONPART_GENERAL_OBSERVATION
    task.extra_data = {sector: capitalize(payload.sector)}
    return Vue.http.post('supervisionpart/observation', {observation: payload.observation}, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
            commit('setSupervisionpart', {sector: payload.sector, supervisionpart: res.body.supervisionPart})
  ...
  createObservationHour ({commit, dispatch}, payload) {
    ...
    task.type = Constants.request_types.SUPERVISIONPART_GENERAL_OBSERVATION
    task.extra_data = {sector: capitalize(payload.sector)}
    return Vue.http.post('supervisionpart/createObservationHour', {observation: payload.observation}, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
  ...
  delRepositionPallet ({commit, dispatch}, payload) {
    ...
    return Vue.http.post('supervisionpart/delRepositionPallet', {observation: payload.observation}, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
            commit('setSupervisionpart', {sector: res.body.supervisionPart.sector, supervisionpart: res.body.supervisionPart})
  ...
  createRepositionPallet ({commit, dispatch}, payload) {
    ...
    task.type = Constants.request_types.SUPERVISIONPART_GENERAL_OBSERVATION
    task.extra_data = {sector: capitalize(payload.observation.sector)}
    return Vue.http.post('supervisionpart/createRepositionPallet', {observation: payload.observation}, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
            commit('setSupervisionpart', {sector: res.body.supervisionPart.sector, supervisionpart: res.body.supervisionPart})
  ...
  createMaterial ({commit, dispatch}, payload) {
    ...
    task.type = Constants.request_types.SUPERVISIONPART_GENERAL_OBSERVATION
    task.extra_data = {sector: capitalize(payload.observation.sector)}
    return Vue.http.post('supervisionpart/createMaterial', {observation: payload.observation}, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
            commit('setSupervisionpart', {sector: res.body.supervisionPart.sector, supervisionpart: res.body.supervisionPart})
  ...
  addVagon ({commit, dispatch}, payload) {
    ...
    task.type = Constants.request_types.SUPERVISIONPART_GENERAL_OBSERVATION
    task.extra_data = {sector: capitalize(payload.observation.sector)}
    return Vue.http.post('supervisionpart/addVagon', {observation: payload.observation}, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
            commit('setSupervisionpart', {sector: res.body.supervisionPart.sector, supervisionpart: res.body.supervisionPart})
  ...
  delMaterial ({commit, dispatch}, payload) {
    ...
    task.type = Constants.request_types.SUPERVISIONPART_GENERAL_OBSERVATION
    task.extra_data = {sector: capitalize(payload.observation.sector)}
    return Vue.http.post('supervisionpart/delMaterial', {observation: payload.observation}, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
            commit('setSupervisionpart', {sector: res.body.supervisionPart.sector, supervisionpart: res.body.supervisionPart})
  ...
  delStopping ({commit, dispatch}, payload) {
    ...
    task.type = Constants.request_types.SUPERVISIONPART_GENERAL_OBSERVATION
    task.extra_data = {sector: capitalize(payload.observation.sector)}
    return Vue.http.post('supervisionpart/delStopping', {observation: payload.observation}, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
            commit('setSupervisionpart', {sector: res.body.supervisionPart.sector, supervisionpart: res.body.supervisionPart})
  ...
  createStopping ({commit, dispatch}, payload) {
    ...
    return Vue.http.post('supervisionpart/createStopping', {observation: payload.stopping}, {headers: {'Idempotency-Key': guid}})
      .then(
        function (res) {
          if (res.body.success) {
            commit('setSupervisionpart', {sector: res.body.supervisionPart.sector, supervisionpart: res.body.supervisionPart})
  ...
  fails ({commit, dispatch}, {sector}) {
    ...
    commit('loading', true)
    Vue.http.get(`supervisionpart/fails/${sector}`)
      .then(
        (res) => {
          if (res.body.success) {
  ...
  loadMore ({commit, state}) {
    ...
    commit('loading', true)
    return Vue.http.get('supervisionpart?page=' + state.page)
      .then(
        (res) => {
          if (res.body.success) {
  ...
  summaries ({commit, dispatch}, payload) {
    ...
    Vue.http.get('supervisionpart/summary', {
      params: params
    })
      .then(
        (res) => {
  ...
  addHistory ({commit}, payload) {
    return new Promise((resolve, reject) => {
      const params = (payload.date !== null && payload.date !== undefined) ? {date: payload.date} : {}
      Vue.http.get(`supervisionpart/comparative/${payload.sector}`, {
        params: params,
        before (request) {
