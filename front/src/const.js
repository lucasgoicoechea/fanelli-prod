export default {
  ...
  BUG_REPORT_SUBSECTORS: {
    ...
    MECACANISMO_CARGA: 'Mecanismo de Carga',
  ...
  BUG_REPORT_TEAM: {
    ...
    CINTA_PULMON_MOVIL: 'Cinta Pulmon Movil',
    CINTA_PULMON_FIJA: 'Cinta Pulmon Fija',
    CINTA_MOVIL_CARGA: 'Cinta Movil Carga',
    MECANISMO_CARGA: 'Mecanismo Carga',
    ...
    ENVOLVEDORA_1_PLANTA_2: 'Envolvedora 1 Planta 2',
    ENVOLVEDORA_2_PLANTA_2: 'Envolvedora 2 Planta 2',
    ENVOLVEDORA_3_PLANTA_3: 'Envolvedora 3 Planta 2',
    ...
    PINZA_BANIATURA_2: 'Pinza Baniatura 2',
  ...
  BUG_REPORT_GROUPS: {
    ...
    LIMPIADOR_ALAMBRE_750: 'Limpiador de Alambre 750',
    ...
    MOTOR_REDUCTOR_BARRERA_1_IZQ: 'Motor/Reductor Barrera Izquierdo',
    MOTOR_REDUCTOR_BARRERA_2_DER: 'Motor/Reductor Barrera Derecha',
    ...
    REDUCTORA_ELEVACION_IZQ: 'Reductora Elevación Izquierdo',
    REDUCTORA_ELEVACION_DER: 'Reductora Elevación Derecho',
    MOTORRED_TRASLACION_PLANCHA: 'Motorred Traslación Plancha',
    MOTORRED_TRASLACION_PALA: 'Motorred Traslación Pala',
  ...
  BUG_REPORT_PARTS: {
    ...
    MOTORRED_SUBE_BAJA: 'Motorred Sube-Baja',
    MOTORRED_TRASLACION: 'Motorred Traslación',
...
// produccion TERMINADA :)
  ...
  BUG_REPORT_SECTORS1: {
    ...
    PLAYA_EXPEDICION: 'Playa y Expedicion',
    PREPARACION_MAT_PRIMAS: 'Preparacion Materia Primas',
    SILO: 'Silo',
