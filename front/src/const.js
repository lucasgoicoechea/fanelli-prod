export default {
  ...
  USER_TYPE_READABLE: {
    ...
    SUPERVISOR: 'Supervisor',
    // Oficial de sector
    OFICIAL_EXTRUSORA: 'Oficial Extrusora L2',
    OFICIAL_APILADORA: 'Oficial Apiladora L2',
    OFICIAL_DESAPILADORA: 'Oficial Desapiladora L2',
  ...
  ROLES: {
    ...
    OFICINA_TECNICA: 'OFICINA_TECNICA',
    JEFE_MANTENIMIENTO: 'JEFE_MANTENIMIENTO',
    OFICIAL_L3: ['OFICIAL_EXTRUSORA_L3', 'OFICIAL_APILADORA_L3', 'OFICIAL_DESAPILADORA_L3'].join('|'),
