...
router.get('/summary', authorize([ROLE.JEFE_PLANTA, ROLE.OFICIALES, ROLE.SUPERVISORES,ROLE.JEFE_LINEA, ROLE.RRHH, ROLE.JEFE_MANTENIMIENTO]), supervisionpartController.summary)
...
router.get('/totalesApiladora', authorize([ROLE.JEFE_LINEA, ROLE.OFICIALES, ROLE.SUPERVISORES,ROLE.JEFE_PLANTA, ROLE.RRHH, ROLE.JEFE_MANTENIMIENTO]), supervisionpartController.totalesApiladora)
router.get('/totalesDesapiladora', authorize([ROLE.JEFE_LINEA, ROLE.OFICIALES, ROLE.SUPERVISORES,ROLE.JEFE_PLANTA, ROLE.RRHH, ROLE.JEFE_MANTENIMIENTO]), supervisionpartController.totalesDesapiladora)
