...
router.get('/fails/:sector', authorize([ROLE.SUPERVISOR_PRODUCCION, ROLE.OFICIALES, ROLE.JEFE_PLANTA, ROLE.JEFE_LINEA, ROLE.RRHH, ROLE.JEFE_MANTENIMIENTO]), supervisionpartController.getFails)
