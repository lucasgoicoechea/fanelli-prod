...
const checklistLTresSchema = new Schema({
  schedule: {
    type: String,
...
checklistLTresSchema.statics.getChecklistsForDayAndSector = function (date, sector) {
...
const checklistLTresModel = mongoose.model('checklistLTres', checklistLTresSchema)

module.exports = checklistLTresModel
